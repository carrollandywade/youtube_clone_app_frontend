...
class Reply extends Component{
    ...
    render(){
        return(
            <React.Fragment>
                <Button className='btn btn-dark btn-sm' onClick={() => {this.setState({show: true})}}>Reply</Button>
                ...
                <Modal.Header closeButton>
                    ...
                    <Modal.Footer>
                        <Button className='btn btn-dark btn-sm' variant="secondary" onClick={() => this.setState({show: false})}>
                            Close
                        </Button>
                    </Modal.Footer>
                </Modal>
